# 使用geotools进行相关文件操作
## 前期准备
maven导入相关包比较困难，下载不下来，建议将需要的相关依赖全部下载自行导入。
## 使用
```java
import java.io.File;  
...
public class FileFormat {  
    ...
    public static void main(String[] args){  
        ...
        String shpPath = "xxxxxxxxxxxxx";  
        String jsonPath = "xxxxxxxxxxxxxxxxxxxxxxx";  
        Map map = fileFormat.shape2Geojson(shpPath, jsonPath);  
          
//      String shpPath = "xxxxxxxxxxxxxxxxx";  
//      String jsonPath = "xxxxxxxxxxxxxxxxxxxxxx";  
